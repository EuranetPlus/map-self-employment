export const config = {
	mapTitle: 'map-self-employment', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-self-employment.vercel.app', // The url provided when deploying the map on Vercel
